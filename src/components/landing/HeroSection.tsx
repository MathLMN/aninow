...
const HeroSection = () => {
  return (
    <section className="min-h-[100svh] flex items-center justify-center bg-gradient-to-b from-[#FAFAFA] from-0% to-[#EDE3DA] to-36% px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center animate-fade-in min-h-[85vh]">
          ...
          <div className="flex items-center justify-center lg:justify-end order-first lg:order-last h-full">
            <div className="relative w-full max-w-2xl h-full flex items-center">
              <img 
                ...
                className="w-full h-auto object-contain animate-fade-in max-h-[85vh]"
                loading="eager"
                fetchPriority="high"
              />
            </div>
