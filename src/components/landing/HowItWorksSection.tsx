const HowItWorksSection = () => {
  ...
  return <section className="bg-gradient-to-b from-vet-blue/5 to-white py-16 sm:py-24">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {steps.map((step, index) => <div key={index} className="group bg-white rounded-2xl p-6 sm:p-8 text-center border-2 border-vet-blue/10 hover:border-vet-blue/40 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
