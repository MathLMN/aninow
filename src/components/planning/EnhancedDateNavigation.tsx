      ...
      <div className="h-full flex flex-col">
        ...
        <div className="flex items-center justify-between mb-1">
          ...
          <div className="text-center flex-1 mx-1">
            ...
            <p className="text-[7px] text-vet-brown">
              8h-12h / 14h-19h
            </p>
          </div>
        ...
        <Button
          ...
          className="w-full text-vet-blue hover:bg-vet-blue/10 h-4 text-[8px] mb-1"
        >
          Aujourd'hui
        </Button>
        ...
        <div className="flex-1 border border-vet-blue/30 rounded-lg overflow-hidden min-h-0">
          <Calendar
            ...
            classNames={{
              ...
              caption: "flex justify-center relative items-center text-[8px] font-medium text-vet-navy py-0.5",
              ...
              head_cell: "text-vet-brown rounded-md w-4 font-normal text-[7px] flex-1 text-center p-0",
