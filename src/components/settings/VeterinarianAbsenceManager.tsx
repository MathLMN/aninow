...
export const VeterinarianAbsenceManager: React.FC<VeterinarianAbsenceManagerProps> = ({
  veterinarians
}) => {
  const { absences, addAbsence, deleteAbsence } = useVeterinarianAbsences();
  ...
  const handleAddAbsence = async (e: React.FormEvent) => {
    ...
    if (!selectedVeterinarian || !newAbsence.start_date || !newAbsence.end_date || !newAbsence.absence_type) {
      return;
    }
  ...
  return (
    <Card className="bg-white/90 backdrop-blur-sm border-vet-blue/30">
      ...
      <CardContent className="space-y-6">
        {/* Add Absence Form */}
        <form onSubmit={handleAddAbsence} className="space-y-4 p-4 bg-vet-beige/10 rounded-lg border border-vet-blue/20">
          <h3 className="font-medium text-vet-navy">Ajouter une absence</h3>
          ...
          <Button type="submit" className="w-full bg-vet-blue hover:bg-vet-blue/90 text-white">
        ...
        <div className="space-y-2">
          <h3 className="font-medium text-vet-navy">Absences programmées</h3>
          {absences.length === 0 ? (
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <span className="font-medium text-vet-navy">
                      {absence.clinic_veterinarians?.name || 'Vétérinaire inconnu'}
                    </span>
                    <span className="text-sm px-2 py-1 bg-vet-blue/10 text-vet-blue rounded">
