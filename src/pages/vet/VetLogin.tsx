...
import { ArrowLeft, Heart, Mail, Lock, Loader2, AlertCircle, ExternalLink } from "lucide-react";
          ...
          <CardContent>
            ...
            <div className="mt-6 text-center space-y-2">
              ...
              <Link to="/discover-aninow-pro">
                <Button variant="link" className="text-vet-sage hover:text-vet-sage/80 font-semibold">
